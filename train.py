...
parser.add_argument('data_directory', type=str, help='Indicate your dataset directory')
parser.add_argument('--save_dir', type=str, default='checkpoints', help='Checkpoint directory')
parser.add_argument('--arch', type=str, choices=['vgg16', 'resnet18'], default='vgg16', help='Model architecture')
